...
class DataSender {
    fun createUpData(): MutableList<UpData> {
        val u1 = UpData("金正恩", Random.Default.nextInt(1, Int.MAX_VALUE), R.drawable.up1)
        val u2 = UpData("特朗普", Random.Default.nextInt(1, Int.MAX_VALUE), R.drawable.up2)
        val u3 = UpData("科比", Random.Default.nextInt(1, Int.MAX_VALUE), R.drawable.up3)
        val u4 = UpData("永雏塔菲", Random.Default.nextInt(1, Int.MAX_VALUE), R.drawable.up4)
        val u5 = UpData("Caigito", Random.Default.nextInt(1, Int.MAX_VALUE), R.drawable.up5)
